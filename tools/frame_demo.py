...
def parse_args():
  ...
  parser.add_argument('--model', dest='model',
            help='model to test',
            default='/home/liuyudong/frame_regression/output/res101/frame_train/default/res101_faster_rcnn_iter_100000.ckpt', type=str)
  parser.add_argument('--gpu', dest='gpu',help='which gpu to use',default = '0')
...
def detect_one(name, thresh=0.75):
  im = cv2.imread(osp.join('data/frame/test_imge', name))
...
if __name__ == '__main__':
  ...
  filename = os.listdir('data/frame/test_imge')
