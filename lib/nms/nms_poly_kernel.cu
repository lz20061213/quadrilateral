...
__global__ void nms_poly_kernel(const int n_boxes, const float nms_overlap_thresh,
...
void _nms_poly(int* keep_out, int* num_out, const float* boxes_host, int boxes_num,
